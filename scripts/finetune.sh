...
PRETRAINED_MODEL_PATH=${PRETRAINED_MODEL_PATH:-"Knowledge-Integrated-Reasoning-VQA/outputs/beit_pretrain_1/ckpts/mp_rank_00_model_states.pt"} # path to the pretrained model, default is the result from our experiments
